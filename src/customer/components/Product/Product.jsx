...
import { womenTops } from "./../../data/women/women_top";
import { filters, singleFilter } from "../../data/filters/filterData";
import {
  FormControl,
  FormControlLabel,
  Radio,
                ...
                {filters.map((section) => (
                  ...
                  >
                    <h3 className="-mx-2 -my-3 flow-root">
                      <DisclosureButton className="group flex w-full items-center justify-between bg-white px-2 py-3 text-gray-600 hover:text-gray-900">
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              <div>
                <div className="hidden md:flex justify-between items-center opacity-50 mb-10">
